...
<<<<<<< HEAD
  const { id: postId, ownerId, name: userName, picture_url: userImg, linkDescription, linkTitle, linkImg, url: link, likes, total_comments } = post;
=======
  const { id: postId, ownerId, name: userName, picture_url: userImg, description, linkTitle, linkDescription, linkImg, url: link, likes, total_comments, who_shared_name} = post;
>>>>>>> ce6583bbb4cbc07d541533e156ad98653b26f359
